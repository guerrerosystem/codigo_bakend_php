...
<section class="content">
    <section class="invoice">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-xs-offset-6">
                ...
                <div class="table-responsive">
                    ...
                    <th></th>
                        <tr>
                            <th>Total Precio del pedido(<?=$currency;?>)</th>
                            <td><?php echo '+ '.$res_total[0]['total']; ?></td>
                        </tr>
                        <tr>
                            <th>comision de envío (<?=$currency;?>)</th>
                        ...
                        <tr>
                            <th>saldo utilizado(<?=$currency;?>)</th>
                            <td><?='- '.$res_outer[0]['wallet_balance']; ?></td>
                        </tr>
                        
                        
                         
                        <th>Total final (<?=$currency;?>)</th>
                        <?php
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <form><button type='button' value='imprime esta página' onclick='printpage();' class="btn btn-default"><i class="fa fa-print"></i> Impresión</button>
                </form>
